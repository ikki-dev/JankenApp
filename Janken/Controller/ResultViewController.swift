...
class ResultViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //相手が出した手を判定
        if resultData == "win"{
            targetImage.image = getPushButtonCategory == "goo" ? chyokiImage : getPushButtonCategory == "choki" ? parImage : gooImage
        }else if resultData == "draw"{
            targetImage.image = getPushButtonCategory == "goo" ? gooImage : getPushButtonCategory == "choki" ? chyokiImage : parImage
        }else{
            targetImage.image = getPushButtonCategory == "goo" ? parImage : getPushButtonCategory == "choki" ? gooImage : chyokiImage
        }
